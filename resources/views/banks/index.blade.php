...
<div class="mb-5 flex flex-wrap items-end justify-between gap-4">
    <div>
        ...
        <div class="flex gap-2"><button type="button" @click="addBankOpen = true" class="rounded-lg bg-slate-100 px-4 py-2.5 text-sm font-bold text-slate-700">+ Add Bank</button><button type="button" @click="transactionOpen = true" class="rounded-lg bg-gray-700 px-4 py-2.5 text-sm font-bold text-white">+ New Transaction</button></div>
</div>
...
<div class="mb-5 grid grid-cols-1 gap-5 xl:grid-cols-3">
    <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white xl:col-span-2">
        <div class="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 px-6 py-5">
            ...
            <span class="rounded-full bg-gray-100 px-3 py-1 text-xs font-bold text-gray-700">Excel Table: BankTransactions</span>
        </div>
