        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-t hover:bg-slate-50 transition-colors" style="border-color:#f1f5f9;">
                    ...
                    <td class="px-6 py-4 text-right text-sm font-bold" style="color:#222222;">{{ pkr($row['outstanding']) }}</td>
                    <td class="px-6 py-4 text-right text-sm text-gray-600">{{ pkr($row['aging_0_30']) }}</td>
                    <td class="px-6 py-4 text-right text-sm" style="color:#444444;">{{ pkr($row['aging_31_60']) }}</td>
                    <td class="px-6 py-4 text-right text-sm" style="color:#222222;">{{ pkr($row['aging_60_plus']) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
