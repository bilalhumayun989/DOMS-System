    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-t hover:bg-slate-50 transition-colors" style="border-color:#f1f5f9;">
                ...
                <td class="px-6 py-4 text-center"><span class="text-xs font-bold px-2 py-1 rounded-lg bg-gray-100 text-gray-700">{{ $row['in_stock'] }}</span></td>
                <td class="px-6 py-4 text-center"><span class="text-xs font-bold px-2 py-1 rounded-lg bg-gray-100 text-gray-700">{{ $row['low_stock'] }}</span></td>
                <td class="px-6 py-4 text-center"><span class="text-xs font-bold px-2 py-1 rounded-lg {{ $row['out_of_stock']>0?'bg-gray-100 text-gray-800':'bg-gray-50 text-gray-400' }}">{{ $row['out_of_stock'] }}</span></td>
