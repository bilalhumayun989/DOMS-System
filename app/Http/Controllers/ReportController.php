...
class ReportController extends Controller
{
    public function index(): View
    {
        $reports = [
            ...
            ['title' => 'Financial Summary', 'description' => 'Daily totals for sales, collections, shortages, expenses, and returns for the current month.', 'route' => route('reports.financial-summary'), 'icon' => 'currency', 'color' => 'green'],
    ...
    public function trips(): View
    {
        ...
        return view('reports.trips', compact('rows'));
    }
